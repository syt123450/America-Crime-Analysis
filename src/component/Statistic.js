...
class Statistic extends Component {
	...
	render() {
		...
		return (
			<div>
				<div id="historyMap" className={"statistic-line history-heatmap"} style={{"height": "500px"}}>
					Loading Heat Map......
				</div>
				<div className={"statistic-line"}>
					...
					<div className={"plot-container"}>
						<XYPlot
							className={"statistic-basic-graph"}
							xType="ordinal"
							stackBy="y"
							width={500}
							height={500}>
							...
							<DiscreteColorLegend
								style={{position: 'fixed', left: '100px', top: '-30px'}}
